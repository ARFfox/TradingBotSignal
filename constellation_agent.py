...
if __name__ == "__main__":
    # La demonstration vit dans constellation_demo.py (regle 17) ; la
    # commande documentee `python3 constellation_agent.py` reste valable.
    from constellation_demo import principal
    principal()
