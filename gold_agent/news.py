...
# Re-exports : les flux (AG-05) vivent dans flux.py depuis le decoupage
# (regle 17). Les appels existants news.minieres/positionnement/saisonnalite
# restent valables.
from .flux import minieres, positionnement, saisonnalite  # noqa: E402,F401
